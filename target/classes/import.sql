...
-- FINANCES
INSERT INTO finances (id, description, cost, month, year, name, value, report_id, user_id) VALUES (1002, 'descricao', false, 01, 2022, 'salariozaum', 1500, 1003, 1001),(1003, 'descricaoCompraMarisa', true, 01, 2022, 'compra marisa', 250, 1003, 1001),(1001, 'descricao', true, 02, 2022, 'compra renner', 150, 1003, 1001);
